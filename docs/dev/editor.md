...
## Требования к настройке сайта в сервисе Pixlpark и внешнего сайта
* Сайт в сервисе Pixlpark и внешний сайт должены быть подготовлены согласно следующим требованиям:
    ...
    + Сайт должен работать на протоколе HTTPS.
    > В разделе "__Настройка / Домены__" должна быть включена опция "__Использовать защищенное соединение (HTTPS)__".
