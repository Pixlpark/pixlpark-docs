...
<!-- > Токен для сквозной аналитики необходимо получить в [Яндекс.Директ](https://direct.yandex.ru) предварительно создав кампанию, в настройках которой необходимо указать идентификатор созданного счетчика Яндекс.Метрика. После создания кампании token для сквозной аналитики будет находится на её странице. После внесения данных токена необходимо сохранить именения нажав "Сохранить" и сбросить кэш сайта.
* ![](../_media/integration/metrik05.png ':size=100%') -->
