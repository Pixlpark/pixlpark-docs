...
* Для получения доступа необходимо перейти на [страницу](https://www.sberbank.ru/ru/s_m_business/bankingservice/acquiring_total) и оставить заявку на эквайринг нажав на кнопку “Оставить заявку”.
