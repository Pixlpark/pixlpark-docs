...
```	formula
Стоимость печати = стоимость печати одной визитки * количество визиток + стоимость листа бумаги * количество листов + наценка за скругление углов + наценка за срочность изготовления,
...
* Этапы расчета:
	...
	5. Наценка за скругление углов
		+ Для того чтобы рассчитать наценку за скругление углов, необходимо умножить количество визиток на стоимость наценки за 1 визитку:
		```formula
		1 * 600 = 600 руб.
		```
...
```	formula
Стоимость печати = стоимость печати листа * количество листов + стоимость бумаги * количество листов + наценка за скругление углов + наценка за срочность изготовления
```
...
* В разделе "__Печать / Калькуляция / Опции__" нажать кнопку "__Добавить__" для создания новой опции.
...
> Назначение опции: наценка каждой визитки за скругление углов визитки.
* В разделе "__Печать / Калькуляция / Опции__" нажать кнопку "__Добавить__" для создания новой опции.
![](../_media/calc/laser-cutting_09.png)
* В открывшейся карточке создания опции заполнить форму, указав:
...
* В подразделе "__Расчет стоимости__" опции "__Скругление углов 45° (Визитки) / Настройка__" задать настройки:
	+ "__Алгоритм расчета позиции__" – выбрать "__Цена позиции фиксированная__".
	+ "__Алгоритм расчета опции__" – выбрать "__Цена опции = кол-во продуктов * цена позиции + доп. цена позиции__".
	+ "__Алгоритм расчета количества опций__" – выбрать "__Количество опций равно количеству продуктов__".
	+ "__Алгоритм выбора позиций__" - выбрать "__Возможен выбор только одной позиции__".
...
* В подразделе "__Основная информация__" опции "__Срок исполнения (Визитки) / Настройка__" заполнить форму, указав:
	...
	+ "__CSS__" – класс – указать "__col5__".
	+ "__Вид выбора позиций на странице редактора__" и "__Вид выбора позиций на странице CMS__" - выбрать список.
