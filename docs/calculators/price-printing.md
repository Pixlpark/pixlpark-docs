...
* Этапы расчета:
    ...
    2. Расчёт надбавки за срочность печати
        + Величина надбавки за срочность печати определяется [таблицей прочих надбавок](/calculators/price-printing?id=price-printing-allowances) и для значения "__2 часа__" составляет 50%. Для определения суммы надбавки необходимо умножить стоимость печати фотографий из п. 1 на 50%.
        ``` formula
