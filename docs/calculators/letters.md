...
* В настроках калькулятора есть опции, которые должны осуществлять надбавку к стоимости в зависимости от цены продукта с учетом всех опций. По этой причине для корректного расчета необходимо расположить настроенные опции в следующем порядке:
    + Подсветка (объемные буквы).
