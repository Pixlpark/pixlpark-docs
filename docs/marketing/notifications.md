...
* __По возможности использовать в качестве обратного адреса письма эл. адрес доставки__ - автоматическая подстановка в качестве обратного адреса эл. почты письма почту пункта выдачи заказа, который выбрал клиент.
...
* Также по нажитию кнопки "Проверить" можно осуществить отправку тестового письма для проверки работоспособности сервера.
