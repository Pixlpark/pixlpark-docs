...
* __Использовать в качестве бонусной программы__ - вместо применения скидки к текущему заказу класть ее значение на личный счет клиента для применения к последующим заказам. Вся логика расчета с личного счета определяется соответствующим способом оплаты.
