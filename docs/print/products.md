...
## Карточка категории
* __Содержание__
    + [Базовая информация](/print/products?id=Базовая-информация)
    + [Продукты](/print/products?id=Продукты)   
    + [Основная информация](/print/products?id=Основная-информация)
    + [Страница категории](/print/productss?id=Страница-категории)
    + [Хлебные крошки](/print/products?id=Хлебные-крошки)
    + [Опции](/print/products?id=Опции)
    + [Заголовки поле](/print/products?id=Заголовки-поле)
    + [Метаинформация](/print/products?id=Метаинформация)
    + [Редактор](/print/products?id=Редактор)
    + [Калькулятор](/print/products?id=Калькулятор)
    + [Атрибуты](/print/products?id=Атрибуты)
    + [Дизайны](/print/products?id=Дизайны)
...
* Перечислим эти блоки:
    ...
    + __Настройка поверхностей__ - задаются настройки поверхностей печати для редактора дизайнов.
...
### Калькулятор
* В данном разделе задается механизм расчета стоимости продукции, который в свою очередь может быть трех типов:
...
* Настройки калькулятора сгруппированы в несколько блоков:
    ...
    + __Офоормление__ - задаются скрипты и стили для визуализации калькулятора.
...
### Редактор
* В данном разделе задаются параметры редактора для данного продукта, а также можно опереопределить общие настройки редактора, заданные в карточке категории.
