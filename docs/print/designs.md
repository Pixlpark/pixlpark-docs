...
* >  Подробнее о подготовке шаблонов можно узнать в [разделе](/design/businesscards).
...
#### Теги
* В данном разделе отображаются и выбираются теги для шаблона, которые в свою очередь определяются в разделе "__Теги дизайнов__".
...
* Также на странице можно:
    ...
    + Привязать теги к выбранные шаблонам.
    + Привязать продукты к выбранные шаблонам.
    + Задать цену для выбранные шаблонов.
