...
* __Позиции и стоимость__
    ...
    ![](../_media/order/items.png ':size=70%')
    ...
    ![](../_media/order/prices.png ':size=70%')
...
* __Добавить позицию__
    + При нажатии ссылки "__добавить__" около заголовка "Элементы заказа" в появившемся модальном окне можно добавить новую позицию к заказу:
        ...
        - Произвольный товар.
* ![](../_media/order/items-add_new.png ':size=50%')
...
* ![](../_media/order/items-edit.png ':size=50%')
...
* ![](../_media/order/items_editor.png ':size=50%')
...
* __Способ доставки__
    ...
    + __Транспортная компания__ - внешняя логистическая компания.
    + __Курьерская служба__ - собственная служба логистики.
...
* __Адрес доставки__ - выбор собственного/партнерского пункта выдачи заказа или указание адреса доставки курьером.
