...
* __Тип заказа__
    + __Обычный заказ__ - заказ продукции от зарегистрированного пользователя через сайт или от сотрудника через панель управления.
    + __Коммерческое предложение__ - намерение зарегистрированного или анонимного пользователя в последующем оформить обычный заказ с указанными характеристиками (используется при создании заказа в панели управления; например, при расчете заказа по телефону).
