...
* __Сменить статус__ - смена текущего статуса заказа либо на один из следующих по [цепочке](/orders/edit?id=_10-Смена-статуса-заказа), либо на произвольный через пункт "Все статусы".
