# Страницы сайта
## Карточка страницы
1. [Основная информация](/cms/pages?id=Основная-информация)
2. [Хлебные крошки](/cms/pages?id=Хлебные-крошки)
3. [Содержимое страницы](/cms/pages?id=Содержимое-страницы)
2. [Метаинформация](/cms/pages?id=Метаинформация)
