...
* Карточка зоны доставки содержит два блока:
    + __Полный адрес__ - адрес зоны доставки, гнде определяющим значением является поле "__Город__", по которому идет выбор подходящей зоны на странице доставки.
    ![](../_media/site/shippings-courier-address-general.png)
    + __Стоимость доставки__ - Валгоритм расчета стоимости доставки в зависимости от веса заказа. 
